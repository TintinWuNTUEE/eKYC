...
class HoloDetector:
    ...
    def checkedTrace(img0, img1, p0, back_threshold=1.0):
        ...
        return p1, status
    def calc_filtered_points(self,qr,ms,mv):
        filtered_points = []
    ...
    def calc_holo_points(self):
        ...
        filtered_points = self.calc_filtered_points(qr,ms,mv)
    ...
    def detect_holos(self, img, search_rect=False):
        ...
        if self.is_training:
            ...
            if self.stack_filled:
                filter_points = self.calc_holo_points()
